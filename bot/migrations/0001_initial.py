# Generated by Django 3.2.3 on 2021-07-01 11:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bot_name', models.CharField(default='Bot 2096', max_length=100, verbose_name='Имя бота')),
                ...
                ('qty_1', models.DecimalField(decimal_places=8, max_digits=9, validators=[bot.models.validate_qty], verbose_name='minQty первой пары')),
                ('qty_2', models.DecimalField(decimal_places=8, max_digits=9, validators=[bot.models.validate_qty], verbose_name='minQty второй пары')),
                ('qty_3', models.DecimalField(decimal_places=8, max_digits=9, validators=[bot.models.validate_qty], verbose_name='minQty третей пары')),
            ],
            options={
                'verbose_name': 'Бота',
